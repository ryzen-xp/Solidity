...
contract DocumentSigningPlatform {
    ...
    function uploadDocument(string memory _documentHash, address _signer) external {
    ...
    function isDocumentSigned(string memory _documentHash) external view returns (bool) {
